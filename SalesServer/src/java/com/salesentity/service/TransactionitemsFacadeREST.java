 ...
 */
package com.salesentity.service;

import com.salesentity.Transactionitems;
import com.salesentity.TransactionitemsPK;
...
public class TransactionitemsFacadeREST extends AbstractFacade<Transactionitems> {
    ...
    private TransactionitemsPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.salesentity.TransactionitemsPK key = new com.salesentity.TransactionitemsPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.salesentity.TransactionitemsPK key = getPrimaryKey(id);
