    ...
    <div class="jumbotron" style="margin-bottom: 0px; background-image: url('<?= base_url('assets/img/students.jpeg'); ?>'); background-size: 100% 100%;">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="home-banner">A gateway to shopping satisfaction for all SFSU users</p>
            </div>
            <div class="col-md-6">
                <img src="<?= base_url('assets/img/Shopping-Cart-Icon-3-800px.png'); ?>" class="img-responsive">
            </div>
        </div>
    </div>
</div>